...
# # ⚠️目的：处理o2_ssp126的数据，把txt文件转成excel文件夹中
# import os
# import re
# import pandas as pd
#
# # 定义文件路径
# input_folder = r'C:\A. climate change and mariculture\ArcGIS\data\conclim\o2'
# output_folder = r'C:\A. climate change and mariculture\Data_Process\climate_o2\126'
#
# # 创建输出文件夹（如果不存在）
# if not os.path.exists(output_folder):
#     os.makedirs(output_folder)
#
# # 正则表达式模式匹配 'o2_all_' 开头的文件名
# pattern = re.compile(r'o2_ssp126_all_.*\.txt')
#
# # 遍历输入文件夹中的所有TXT文件
...
# import os
#
# folder_path = r'C:\A. climate change and mariculture\Data_Process\climate_o2\126'
#
# # 获取文件夹中所有Excel文件的文件名
...
# # ⚠️目的：将o2_ssp126_eez_{year}.{month}.xlsx 按年份合并数。挑选出一年中最高温和最低温月份盐度值。
# import os
# import pandas as pd
#
# # 文件夹路径
...
#
# # 获取所有符合命名规则的文件
# file_pattern = "o2_eez_all_{year}.{month}.xlsx"
# files = [f for f in os.listdir(folder_path) if f.startswith("o2_eez_all_") and f.endswith(".xlsx")]
#
# # 按年份合并文件
# yearly_files = {}
# for file in files:
...
#
#     # 保存结果到新的Excel文件
#     output_path = os.path.join(folder_path, f'o2_ssp126_eez_m_{year}.xlsx')
#     result_grouped.to_excel(output_path, index=False, sheet_name='o2_min_max')
#     print(f"1.4已完成")
...
# # 定义文件路径
# folder_path = r'C:\A. climate change and mariculture\Data_Process\climate_o2\126'
# points_files = glob.glob(os.path.join(folder_path, 'o2_ssp126_eez_m_*.xlsx'))
#
# # 定义函数来填补空白值
# def fill_missing_values(df):
#     # 获取需要填补的列
#     cols_to_fill = ['o2_min', 'o2_max']
#
...
#
#     # 定义输出文件路径
#     output_file_path = os.path.join(folder_path, f'o2_ssp126_m_eez_filled_{year}.xlsx')
#
#     # 保存填补后的结果到Excel文件
...
# # 每块代码单独运算
# # ---------------------------------------section1.1气候数据格式数据处理---------------------------------------------------
# # ⚠️目的：处理o2_ssp585的数据，把txt文件转成excel文件夹中
# import os
# import re
# import pandas as pd
#
# # 定义文件路径
# input_folder = r'C:\A. climate change and mariculture\ArcGIS\data\conclim\o2'
# output_folder = r'C:\A. climate change and mariculture\Data_Process\climate_o2\585'
#
# # 创建输出文件夹（如果不存在）
# if not os.path.exists(output_folder):
#     os.makedirs(output_folder)
#
# # 正则表达式模式匹配 'o2_all_' 开头的文件名
# pattern = re.compile(r'o2_ssp585_all_.*\.txt')
#
# # 遍历输入文件夹中的所有TXT文件
# for filename in os.listdir(input_folder):
#     if pattern.match(filename):
...
# import os
#
# folder_path = r'C:\A. climate change and mariculture\Data_Process\climate_o2\585'
#
# # 获取文件夹中所有Excel文件的文件名
# excel_files = [f for f in os.listdir(folder_path) if f.endswith('.xlsx') or f.endswith('.xls')]
#
...
#
# # ----------------------------------------section1.4原始数据格式数据处理--------------------------------------------------
# # ⚠️目的：将o2_ssp585_eez_{year}.{month}.xlsx 按年份合并数。挑选出一年中最高温和最低温月份盐度值。
# import os
# import pandas as pd
#
# # 文件夹路径
...
#
#     # 保存结果到新的Excel文件
#     output_path = os.path.join(folder_path, f'o2_ssp585_eez_m_{year}.xlsx')
#     result_grouped.to_excel(output_path, index=False, sheet_name='o2_min_max')
#
# # -------------------------------------------section2.1补充o2空白值----------------------------------------------------
# # ⚠️目的：补充无o2数据的点位。
...
# # 定义文件路径
# folder_path = r'C:\A. climate change and mariculture\Data_Process\climate_o2\585'
# points_files = glob.glob(os.path.join(folder_path, 'o2_ssp585_eez_m_*.xlsx'))
#
#
# # 定义函数来填补空白值
# def fill_missing_values(df):
...
#
#     # 定义输出文件路径
#     output_file_path = os.path.join(folder_path, f'o2_ssp585_m_eez_filled_{year}.xlsx')
#
#     # 保存填补后的结果到Excel文件
#     with pd.ExcelWriter(output_file_path) as writer:
#         filled_df.to_excel(writer, index=False)
...
# # 每块代码单独运算
# # ---------------------------------------section1.1气候数据格式数据处理---------------------------------------------------
# # ⚠️目的：处理o2_historical的数据，把txt文件转成excel文件夹中
# import os
# import re
# import pandas as pd
#
# # 定义文件路径
# input_folder = r'C:\A. climate change and mariculture\ArcGIS\data\conclim\o2'
# output_folder = r'C:\A. climate change and mariculture\Data_Process\climate_o2\historical'
#
# # 创建输出文件夹（如果不存在）
# if not os.path.exists(output_folder):
#     os.makedirs(output_folder)
#
# # 正则表达式模式匹配 'o2_all_' 开头的文件名
# pattern = re.compile(r'o2_historical_all_.*\.txt')
#
# # 遍历输入文件夹中的所有TXT文件
# for filename in os.listdir(input_folder):
#     if pattern.match(filename):
...
# import os
#
# folder_path = r'C:\A. climate change and mariculture\Data_Process\climate_o2\historical'
#
# # 获取文件夹中所有Excel文件的文件名
# excel_files = [f for f in os.listdir(folder_path) if f.endswith('.xlsx') or f.endswith('.xls')]
#
...
#
# # ----------------------------------------section1.4原始数据格式数据处理--------------------------------------------------
# # ⚠️目的：将o2_historical_eez_{year}.{month}.xlsx 按年份合并数。挑选出一年中最高温和最低温月份盐度值。
# import os
# import pandas as pd
#
# # 文件夹路径
...
#
#     # 保存结果到新的Excel文件
#     output_path = os.path.join(folder_path, f'o2_historical_eez_m_{year}.xlsx')
#     result_grouped.to_excel(output_path, index=False, sheet_name='o2_min_max')
#
# # -------------------------------------------section2.1补充o2空白值----------------------------------------------------
# # ⚠️目的：补充无o2数据的点位。
...
# # 定义文件路径
# folder_path = r'C:\A. climate change and mariculture\Data_Process\climate_o2\historical'
# points_files = glob.glob(os.path.join(folder_path, 'o2_historical_eez_m_*.xlsx'))
#
#
# # 定义函数来填补空白值
# def fill_missing_values(df):
...
#
#     # 定义输出文件路径
#     output_file_path = os.path.join(folder_path, f'o2_historical_m_eez_filled_{year}.xlsx')
#
#     # 保存填补后的结果到Excel文件
#     with pd.ExcelWriter(output_file_path) as writer:
#         filled_df.to_excel(writer, index=False)
...
# # 定义文件路径
# folder_path = r'C:\A. climate change and mariculture\Data_Process\climate_o2\historical'
# species_file_path = r'C:\A. climate change and mariculture\Data_Process\species\species_o2_m.xlsx'
#
# # 读取物种数据
# species_df = pd.read_excel(species_file_path)
#
# # 获取所有年份的点位数据文件路径
# points_files = glob.glob(os.path.join(folder_path, 'o2_historical_m_eez_filled_*.xlsx'))
#
# # 对于每个年份的点位数据文件
# for file_path in points_files:
#     # 获取年份
...
#         i, j, point_o2_max = point['i'], point['j'], point['o2_max']
#
#         # 对于每个物种
#         for _, species in species_df.iterrows():
#             species_no, species_name, species_o2_max = species['No.'], species['species'], species['o2_max']
#
#             # 判断物种是否能在该点位生存
#             suitable = species_o2_max >= point_o2_max
#
#             result = {
#                 'i': i,
#                 'j': j,
...
#
#     # 定义输出文件路径
#     output_file_path = os.path.join(folder_path, f'o2_historical_eez_filled_species_m_{year}.xlsx')
#
#     # 保存结果到Excel文件
#     with pd.ExcelWriter(output_file_path) as writer:
...
#
# # 文件夹路径
# folder_path = r'C:\A. climate change and mariculture\Data_Process\old\climate_o2\historical'
# folder_out_path = r'C:\A. climate change and mariculture\Data_Process\new\climate_o2\historical'
#
# # 获取所有符合命名规则的文件
# file_pattern = "o2_eez_all_{year}.{month}.xlsx"
# files = [f for f in os.listdir(folder_path) if f.startswith("o2_eez_all_") and f.endswith(".xlsx")]
...
#
#     # 保存结果到新的Excel文件
#     output_path = os.path.join(folder_out_path, f'o2_historical_eez_mean_{year}.xlsx')
#     result_grouped.to_excel(output_path, index=False, sheet_name='o2_mean')
# #
# # ---------------------------------------⚠️section5.1补充o2空白值----------------------------------------------------
# # ⚠️目的：补充无o2数据的点位。
# # 使用最近邻插值方法，找到每个空白值的最近非空值进行填补。
...
# folder_out_path = r'C:\A. climate change and mariculture\Data_Process\new\climate_o2\historical'
# points_files = glob.glob(os.path.join(folder_path, 'o2_historical_eez_*.xlsx'))
#
#
# # 定义函数来填补空白值
# def fill_missing_values(df):
#     # 获取需要填补的列
#     cols_to_fill = ['o2_mean']
#
#     for col in cols_to_fill:
#         # 获取所有非空值的索引
#         non_null_points = df[['i', 'j', col]].dropna()
...
#
# # 文件夹路径
# folder_path = r'C:\A. climate change and mariculture\Data_Process\old\climate_o2\126'
# folder_out_path = r'C:\A. climate change and mariculture\Data_Process\new\climate_o2\126'
#
# # 获取所有符合命名规则的文件
# file_pattern = "o2_eez_all_{year}.{month}.xlsx"
...
#
#     # 保存结果到新的Excel文件
#     output_path = os.path.join(folder_out_path, f'o2_ssp126_eez_mean_{year}.xlsx')
#     result_grouped.to_excel(output_path, index=False, sheet_name='o2_mean')
#
# # ---------------------------------------⚠️section5.1补充o2空白值----------------------------------------------------
# # ⚠️目的：补充无o2数据的点位。
...
# folder_path = r'C:\A. climate change and mariculture\Data_Process\new\climate_o2\126'
# folder_out_path = r'C:\A. climate change and mariculture\Data_Process\new\climate_o2\126'
# points_files = glob.glob(os.path.join(folder_path, 'o2_ssp126_eez_*.xlsx'))
#
#
# # 定义函数来填补空白值
# def fill_missing_values(df):
...
#
#     # 定义输出文件路径
#     output_file_path = os.path.join(folder_out_path, f'o2_ssp126_m_eez_filled_{year}.xlsx')
#
#     # 保存填补后的结果到Excel文件
#     with pd.ExcelWriter(output_file_path) as writer:
#         filled_df.to_excel(writer, index=False)
...
#
# # 文件夹路径
# folder_path = r'C:\A. climate change and mariculture\Data_Process\old\climate_o2\585'
# folder_out_path = r'C:\A. climate change and mariculture\Data_Process\new\climate_o2\585'
#
# # 获取所有符合命名规则的文件
# file_pattern = "o2_eez_all_{year}.{month}.xlsx"
...
#
#     # 保存结果到新的Excel文件
#     output_path = os.path.join(folder_out_path, f'o2_ssp585_eez_mean_{year}.xlsx')
#     result_grouped.to_excel(output_path, index=False, sheet_name='o2_mean')
#
# # ---------------------------------------⚠️section5.1补充o2空白值----------------------------------------------------
# # ⚠️目的：补充无o2数据的点位。
...
# points_files = glob.glob(os.path.join(folder_path, 'o2_ssp585_eez_*.xlsx'))
#
#
# # 定义函数来填补空白值
# def fill_missing_values(df):
...
#
#     # 定义输出文件路径
#     output_file_path = os.path.join(folder_output_path, f'o2_ssp585_m_eez_filled_{year}.xlsx')
#
#     # 保存填补后的结果到Excel文件
#     with pd.ExcelWriter(output_file_path) as writer:
#         filled_df.to_excel(writer, index=False)
...
#
#     # 按照i和j分组，计算每组的平均值
#     result_df = combined_df.groupby(['i', 'j']).agg({'o2_mean': 'mean'}).reset_index()
#
#     # 保存结果到新的Excel文件中
...
# # 调用函数处理不同的文件
# files_info = [
#     ('historical', 'o2_historical_m_eez_filled_', 'o2_historical_5year.xlsx'),
#     ('126', 'o2_ssp126_m_eez_filled_202', 'o2_ssp126_20-24_5year.xlsx'),
#     ('126', 'o2_ssp126_m_eez_filled_203', 'o2_ssp126_30-34_5year.xlsx'),
#     ('126', 'o2_ssp126_m_eez_filled_204', 'o2_ssp126_40-44_5year.xlsx'),
#     ('126', 'o2_ssp126_m_eez_filled_205', 'o2_ssp126_50-54_5year.xlsx'),
#     ('585', 'o2_ssp585_m_eez_filled_202', 'o2_ssp585_20-24_5year.xlsx'),
#     ('585', 'o2_ssp585_m_eez_filled_203', 'o2_ssp585_30-34_5year.xlsx'),
#     ('585', 'o2_ssp585_m_eez_filled_204', 'o2_ssp585_40-44_5year.xlsx'),
#     ('585', 'o2_ssp585_m_eez_filled_205', 'o2_ssp585_50-54_5year.xlsx')
# ]
#
